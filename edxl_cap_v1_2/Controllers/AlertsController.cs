...
namespace edxl_cap_v1_2.Controllers
{
    public class AlertsController : Controller
    {
        ...
        public IActionResult PickAlert(Alert obj, int? SelectedAlertIndex)
        {
            ...
            return View("Assemble.cshtml", _context.Alert.Where(x => x.AlertIndex == SelectedAlertIndex));
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var alert = await _context.Alert
                ...
                .AsNoTracking()
                .FirstOrDefaultAsync(m => m.AlertIndex == id);
        ...
        public async Task<IActionResult> _DetailsAlertA(int? id)
        {
            if (id == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
            ...
            var alertToUpdate = await _context.Alert.FirstOrDefaultAsync(s => s.AlertIndex == id);
