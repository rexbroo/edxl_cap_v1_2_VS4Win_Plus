    ...
    public class ResourcesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var resource = await _context.Resource
                ...
                .AsNoTracking()
                .FirstOrDefaultAsync(m => m.ResourceIndex == id);
        ...
        public async Task<IActionResult> Create([Bind("ResourceDesc,MimeType,Size,Uri,DerefUri,Digest,Info_Alert_Identifier,DataCategory_Id")] Resource resource)
        {
            try
            {
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
            ...
            var resourceToUpdate = await _context.Resource.FirstOrDefaultAsync(r => r.ResourceIndex == id);
