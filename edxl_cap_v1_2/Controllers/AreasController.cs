    ...
    public class AreasController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var area = await _context.Area
                ...
                .AsNoTracking()
                .FirstOrDefaultAsync(m => m.AreaIndex == id);
        ...
        public async Task<IActionResult> Create([Bind("AreaDesc,Polygon,Circle,Geocode,Altitude,Ceiling,DataCategory_Id")] Area area)
        {
            try
            {
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
            ...
            var areaToUpdate = await _context.Area.FirstOrDefaultAsync(s => s.AreaIndex == id);
