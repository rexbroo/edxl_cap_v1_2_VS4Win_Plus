    ...
    public class InfosController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var info = await _context.Info
                ...
                .AsNoTracking()
                .FirstOrDefaultAsync(m => m.InfoIndex == id);
        ...
        public async Task<IActionResult> Create(
            [Bind("Language,Category,Event,ResponseType,Urgency,Certainty,Severity,Audience,EventCode,Effective,Onset,Expires,SenderName,Headline,Description,Instruction,Web,Contact,Parameter,DataCategory_Id")] Info info)
        {
            try
            {
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
            ...
            var infoToUpdate = await _context.Info.FirstOrDefaultAsync(s => s.InfoIndex == id);
